...
function Faq({setActiveLink}) {
    ...
    <div id="FAQ" className="min-h-screen flex flex-col items-center justify-center py-30 w-4/5 mx-auto"  ref={ref}>
      ...
      {!isSmallScreen ? (<div id="accordion" className="grid grid-cols-2 items-start gap-4 w-full p-4 mt-4">
            ...
            <FaqCard question={"What do I need to bring?"} answer={"Just bring your laptop and charger, and you're good to go! Feel free to bring along anything else that makes you comfortable and ready to hack."}/>
            </div>
